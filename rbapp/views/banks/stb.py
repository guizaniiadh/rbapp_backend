"""
STB BANK Specific Views

This module contains all STB-specific views that handle:
- STB bank ledger preprocessing
- STB-specific matching algorithms (sensitive matching rules)
- STB beginning balance extraction
- STB customer tax extraction
- STB transaction matching
- Other STB-specific processing

All views inherit from base classes in base.py and implement STB-specific logic.

This module also contains STB-specific helper methods/functions that are used
by the views but are specific to STB's data format and business rules.
"""
...
class STBPreprocessBankLedgerEntryView(APIView):
    ...
    def post(self, request, pk):
        try:
            ...
            # STB-specific: Remove negative sign from Débit column (convert all negative values to positive)
            if 'Débit' in df_cleaned.columns:
            ...
            for _, row in df_cleaned.iterrows():
                ...
                # STB-specific: Ensure débit is always positive (remove negative sign)
...
class STBExtractBeginningBalanceView(APIView):
    """
...
class STBMatchCustomerBankTransactionsView(APIView):
    permission_classes = [permissions.IsAuthenticated]
...
class STBMatchBankTransactionTaxesView(APIView):
    permission_classes = [permissions.IsAuthenticated]

    def post(self, request):
        try:
            print("=" * 80)
            print("STBMatchBankTransactionTaxesView: Starting processing")
            print("=" * 80)
            logger.info("=" * 80)
            logger.info("STBMatchBankTransactionTaxesView: Starting processing")
            logger.info("=" * 80)
            ...
            print("=" * 80)
            print("STBMatchBankTransactionTaxesView: Final Statistics")
            print("=" * 80)
            ...
            print("=" * 80)
            logger.info("=" * 80)
            logger.info("STBMatchBankTransactionTaxesView: Final Statistics")
            logger.info("=" * 80)
            ...
            error_details = traceback.format_exc()
            logger.error("=" * 80)
            logger.error(f"STBMatchBankTransactionTaxesView: ERROR occurred")
            logger.error("=" * 80)
...
class STBExtractCustomerTaxesView(APIView):
    """
    ...
    def post(self, request, *args, **kwargs):
        try:
            print("=" * 80)
            print("STBExtractCustomerTaxesView: Starting tax extraction")
            print("=" * 80)
            logger.info("=" * 80)
            logger.info("STBExtractCustomerTaxesView: Starting tax extraction")
            logger.info("=" * 80)
            ...
            print(f"\n{'=' * 80}")
            print("STBExtractCustomerTaxesView: Final Statistics")
            print(f"{'=' * 80}")
            ...
            logger.info("=" * 80)
            logger.info("STBExtractCustomerTaxesView: Final Statistics")
            ...
            error_details = traceback.format_exc()
            print(f"\n{'=' * 80}")
            print("❌ CRITICAL ERROR in STBExtractCustomerTaxesView")
            print(f"{'=' * 80}")
            print(f"Error: {str(e)}")
            print(f"\nTraceback:\n{error_details}")
            print(f"{'=' * 80}")
            logger.error("=" * 80)
            logger.error("STBExtractCustomerTaxesView: CRITICAL ERROR")
            logger.error(f"Error: {str(e)}")
            logger.error(f"Traceback:\n{error_details}")
            logger.error("=" * 80)
            return Response({
...
class STBMatchCustomerBankTransactionsView1(APIView):
    permission_classes = [permissions.IsAuthenticated]
...
class STBPreprocessCustomerLedgerEntryView(APIView):
    permission_classes = [permissions.IsAuthenticated]
    parser_classes = [parsers.JSONParser, parsers.MultiPartParser, parsers.FormParser]
...
class STBGetMatchingResultsView(APIView):
    permission_classes = [permissions.IsAuthenticated]
...
class STBTaxComparisonView(APIView):
...
class STBMatchTaxView(APIView):
    ...
    def post(self, request):
        try:
            print("=" * 80)
            print("STBMatchTaxView: Starting tax matching")
            print("=" * 80)
            logger.info("=" * 80)
            logger.info("STBMatchTaxView: Starting tax matching")
            logger.info("=" * 80)
            ...
            print(f"\n{'=' * 80}")
            print("STBMatchTaxView: Final Statistics")
            print(f"{'=' * 80}")
            ...
            logger.info("=" * 80)
            logger.info("STBMatchTaxView: Final Statistics")
            ...
            print(f"\n{'=' * 80}")
            print(f"❌ CRITICAL ERROR in STBMatchTaxView")
            print(f"{'=' * 80}")
            print(f"Error: {error_msg}")
            print(f"\nTraceback:\n{error_details}")
            print(f"{'=' * 80}")
            logger.error("=" * 80)
            logger.error("STBMatchTaxView: CRITICAL ERROR")
            logger.error(error_msg)
            logger.error(f"Traceback:\n{error_details}")
            logger.error("=" * 80)
            return Response(
...
class STBSortedRecoBankTransactionsView(APIView):
    """
    ...
    def get(self, request):
        try:
            ...
            import traceback
            error_details = traceback.format_exc()
            logger.error(f"Error in STBSortedRecoBankTransactionsView: {str(e)}\n{error_details}")
            return Response({
                "error": str(e),
                "details": error_details
            }, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
class STBUnmatchedTransactionsView(APIView):
    """
